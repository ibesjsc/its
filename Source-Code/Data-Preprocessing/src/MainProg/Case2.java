 ...
 */
public class Case2 {
    public static int LOOK_BACK = 1;
    // Xem k speed trước đó là các features (hoặc có thể đổi lại xem như là k time_step)
    public static void ProcessingDataTimeStep_1_Feature_k(String inFileName, String outFileName) throws FileNotFoundException, IOException{
