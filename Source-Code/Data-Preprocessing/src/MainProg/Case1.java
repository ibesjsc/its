 ...
 */
public class Case1 {
    public static int LOOK_BACK = 1; // Không thay đổi tham số này cho CASE 1
    public static void ProcessingDataTimeStep_1_Feature_1(String inFileName, String outFileName) throws FileNotFoundException, IOException{
