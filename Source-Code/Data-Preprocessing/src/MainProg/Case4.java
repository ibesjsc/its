...
public class Case4 {
    ...
    // Xét feature Framely
    public static void ProcessingDataTimeStep_k_Feature_3(String inFileName, String outFileName) throws FileNotFoundException, IOException{
	...
	FileWriter fw = null;
        ...
        for(int k = 0; k < LOOK_BACK; k++){
            wHeader = wHeader+ "daily"+k + ",frame"+k+",speed" + k + ",";
        }
